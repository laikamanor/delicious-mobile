...
import com.example.deliciouspartnerapp.Helper.FragmentNavigationManager_API_SalesLogsItems;
...
public class API_SalesLogsItems extends AppCompatActivity {
    ...
    notification_class notifc = new notification_class(API_SalesLogsItems.this);
            ...
            try{
                ...
                if(jsonObject1.getBoolean("success")){
                    ...
                    if(typeTrans.equals("Sales Transactions")) {
                        ...
                        headerFormat = "Remarks: " + jsonObject.getString("remarks");
                    }
