...
public class DatabaseHelper3 extends SQLiteOpenHelper {
    public static final String DATABASE_NAME = "qqzz.db";
    public static final String TABLE_NAME = "tbl_qqzz";
    ...
    public  static  final String COL_17 = "remarks";
    public  static  final String COL_18 = "transdate";
    ...
    public boolean insertData(String sapNumber, String fromBranch,  String itemName,Double quantity,Double actual_quantity,int isSAPIT,String toBranch,int baseID, String fromModule,int isSelected, String uom,int received_quantity, int item_id, int objtype, int isClosed, String remarks, String transDate){
        ...
        contentValues.put(COL_17, remarks);
        contentValues.put(COL_18, transDate);
