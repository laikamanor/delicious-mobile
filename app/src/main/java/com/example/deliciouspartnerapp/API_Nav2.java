...
import com.example.deliciouspartnerapp.Helper.FragmentNavigationManager;
...
//    private String[] items;
    ...
    notification_class notifc = new notification_class(API_Nav2.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myDb7 = new DatabaseHelper7(getBaseContext());
