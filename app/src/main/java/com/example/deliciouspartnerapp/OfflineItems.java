...
import com.example.deliciouspartnerapp.Helper.FragmentNavigationManager_OfflineItems;
...
public class OfflineItems extends AppCompatActivity {
    ...
    notification_class notifc = new notification_class(OfflineItems.this);
